...
- Chrome Web Store caps the short description at 132 characters; Firefox/AMO can use a longer manifest description.
- Large design sources under `tools/icon-source/` are gitignored and not shipped.
...
# Regenerate toolbar icons (newest PNG in tools/icon-source/)
